    ...
    return (
        <section id="techStack" className="section-padding">
            <div className="container">
                    ...
                    <ul>
                        <li>
                            <div className="html" style={{'--color': '#e96228'}}>
                                ...
                                <span className="layer layer0"></span>
                        ...
                        <li>
                            ...
                            {/* <span className="fa fa-bug fa-inverse fa-5x"></span> */}
                                ...
                                <span className="walls"><span>javascript</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="sass" style={{'--color': '#f739a8'}}>
                                ...
                                <span className="walls"><span>sass</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="reactjs" style={{'--color': '#08d2f6'}}>
                                ...
                                <span className="walls"><span>react</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="redux" style={{'--color': '#7248b6'}}>
                                ...
                                <span className="walls"><span>redux</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="bootstrap" style={{'--color': '#6c15e3'}}>
                                ...
                                <span className="walls"><span>bootstrap</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="threejs" style={{'--color': '#55acee'}}>
                                ...
                                <span className="walls"><span>nothing</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="nodejs" style={{'--color': '#8cbf3d'}}>
                                ...
                                <span className="walls"><span>nodejs</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="mongoDb" style={{'--color': '#00a940'}}>
                                ...
                                <span className="walls"><span>mongodb</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                        ...
                        <li>
                            <div className="mongoDb" style={{'--color': '#ce00e7'}}>
                                ...
                                <span className="walls"><span>jquery</span></span>
                                <span className="layer layer0"></span>
                                <span className="layer layer2"></span>
                                <span className="layer layer3"></span>
                                <span className="layer layer4"></span>
                ...
                <div className="row d-flex justify-content-center align-items-center" style={{marginTop: '15rem'}}>
                    <div className="slider-ground">
